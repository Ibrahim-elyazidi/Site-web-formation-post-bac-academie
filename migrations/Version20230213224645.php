 ...
 */
final class Version20230213224645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE departement CHANGE num_departement num INT NOT NULL, CHANGE nom_departement nom VARCHAR(25) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE departement CHANGE num num_departement INT NOT NULL, CHANGE nom nom_departement VARCHAR(25) NOT NULL');
    }
}
