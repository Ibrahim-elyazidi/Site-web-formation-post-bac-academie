 ...
 */
final class Version20230125140124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE referent (id INT AUTO_INCREMENT NOT NULL, etablissement_id INT NOT NULL, nom_ref VARCHAR(50) NOT NULL, prenom_ref VARCHAR(50) NOT NULL, adresse_ref VARCHAR(50) NOT NULL, telephone_ref VARCHAR(10) NOT NULL, INDEX IDX_FE9AAC6CFF631228 (etablissement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE site_web (id INT AUTO_INCREMENT NOT NULL, formation_id INT DEFAULT NULL, lien VARCHAR(255) NOT NULL, INDEX IDX_E15409715200282E (formation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE site_web ADD CONSTRAINT FK_E15409715200282E FOREIGN KEY (formation_id) REFERENCES formation (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE site_web DROP FOREIGN KEY FK_E15409715200282E');
